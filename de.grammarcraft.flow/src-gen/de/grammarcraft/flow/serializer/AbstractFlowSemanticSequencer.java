...
public class AbstractFlowSemanticSequencer extends AbstractSemanticSequencer {
	...
	protected void sequence_NativeClass(EObject context, NativeClass semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getNativeClassAccess().getReferenceJvmTypeReferenceParserRuleCall_0(), semanticObject.getReference());
		feeder.finish();
	}
	...
	protected void sequence_Stream(EObject context, Stream semanticObject) {
		...
		feeder.accept(grammarAccess.getStreamAccess().getMessageJvmTypeReferenceParserRuleCall_2_0(), semanticObject.getMessage());
