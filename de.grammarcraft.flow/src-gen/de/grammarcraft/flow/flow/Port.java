 ...
 * <ul>
 *   <li>{@link de.grammarcraft.flow.flow.Port#getFunctionUnit <em>Function Unit</em>}</li>
...
public interface Port extends LeftPort, RightPort
{
   ...
   * @see de.grammarcraft.flow.flow.FlowPackage#getPort_FunctionUnit()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.grammarcraft.flow.flow.Port#getFunctionUnit <em>Function Unit</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
