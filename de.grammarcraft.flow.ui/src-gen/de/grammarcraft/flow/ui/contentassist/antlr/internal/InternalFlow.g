...
:
(
{ before(grammarAccess.getStreamAccess().getMessageJvmTypeReferenceParserRuleCall_2_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getStreamAccess().getMessageJvmTypeReferenceParserRuleCall_2_0()); }
)
...
:
(
{ before(grammarAccess.getNativeClassAccess().getReferenceJvmTypeReferenceParserRuleCall_0()); }
	ruleJvmTypeReference{ after(grammarAccess.getNativeClassAccess().getReferenceJvmTypeReferenceParserRuleCall_0()); }
)
