 ...
 * <ul>
 *   <li>{@link de.grammarcraft.csflow.flow.impl.OperationTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperationTypeImpl extends MinimalEObjectImpl.Container implements OperationType
{
  ...
  {
    return FlowPackage.Literals.OPERATION_TYPE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FlowPackage.OPERATION_TYPE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FlowPackage.OPERATION_TYPE__NAME:
        return getName();
    }
